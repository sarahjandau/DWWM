    ...
    <div class="containerCrud">
        <div class="containerMenuCrud"> 
            <div class="menuHeader">
                <img src="img/logoJOBlanc.svg" alt="Logo Paris 2024">
            </div>
            <nav class="menuNavigation">
                <h2>Tableau de bord</h2>
                <ul>
                    <li><a href="readUser.php">Utilisateurs</a></li>
                    <li><a href="readEquipes.php#">Equipes</a></li>
                    <li><a href="readJoueurs.php">Joueurs</a></li>
                    <li><a href="readRencontres.php">Matchs</a></li>
